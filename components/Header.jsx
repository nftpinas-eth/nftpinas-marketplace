...
const style = {
    ...
    searchBar: `flex flex-1 mx-[0.8rem] my-[0.4rem] w-[520px] items-center bg-white border-[1.5px] b rounded-[1.8rem] hover:bg-[#EEEEEF]`,
    ...
    navbarStatus: `md:flex hidden inline-flex items-center px-1.5 py-2 rounded-full text-xs bg-red-100 text-red-800 red-pulse cursor-pointer `,
    ...
    <div className={style.navbarWrapper}>
        ...
        <div className={style.navbarItems}>
            <div className={style.navbarStatus}>
                ...
                <span className='px-1 m1-1.5 font-sans font-bold'>In-Development</span>
            </div>
            ...
            <ul className={style.navbarListItems}>
                <Link href="/"><div className={style.navbarItem}> Explore </div></Link>
                <Link href="/"><div className={style.navbarItem}> Collection </div></Link>
                <Link href="/"><div className={style.navbarItem}> Mint </div></Link>
            ...
            <div className="relative flex">
                {toggleMenu
                    ? <AiOutlineClose fontSize={28} className="text-black cursor-pointer md:hidden" onClick={() => setToggleMenu(false)} />
                    : <HiMenuAlt4 fontSize={28} className="text-black cursor-pointer md:hidden" onClick={() => setToggleMenu(true)} />}
                {toggleMenu && (
                    <ul className={style.navbarMenuListItems} >
                        <Link href="/"><div className={style.navbarItem}><MdOutlineExplore className='m-1 w-7 h-7' /> Explore  </div></Link>
                        <Link href="/"><div className={style.navbarItem}><BiCollection className='m-1 w-7 h-7' /> Collection </div></Link>
                        <Link href="/"><div className={style.navbarItem}><FiPlusSquare className='m-1 w-7 h-7' /> Mint </div></Link>
                        <li className={style.wallet}>
                        {address ? (
                            <button>
                                <p className=''>{
