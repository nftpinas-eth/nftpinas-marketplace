...
const style = {
  ...
  siteInfoWrapper:
    "z-1 relative flex flex-col py-8 md:w-[760px] md:rounded-xl text-center md:border md:border-slate-100 md:bg-white md:shadow-xl md:mb-[-3rem] ",
    ...
    <div className={style.sectionWrapper}>
      <div className={style.contentWrapper}>
        <div className={style.contentItems}>
          <div className={style.title}>Support Filipino #NFT Projects</div>
      ...
      <div className={style.siteInfoWrapper}>
        <div className={style.siteInfoContainer}>
          <p className="flex flex-col items-center w-full font-semibold md:flex-row text-slate-800">
            <BsFillShieldFill className="w-8 h-8 mx-2" /> Fully Secured
          </p>
          <p className="flex flex-col items-center w-full font-semibold md:flex-row text-slate-800">
            <BsGlobe className="w-8 h-8 mx-2" />
            Built-in zkSync
          </p>
          <p className="flex flex-col items-center w-full font-semibold md:flex-row text-slate-800">
            <GrTransaction className="w-8 h-8 mx-2" />
            Cheaper Transaction
          </p>
        </div>
      </div>
